...
<section class="nri-nice-review-wrapper" id="nri-slug-wrapper" data-slug="<?php echo esc_html($this->slug); ?>">
  <div class="nri-nice-review nri-CDP" id="nri-sub-wrapper">
    ...
    <div class="nri-content">
      <div class="nri-text">
        <p>You’ve been using the <a href="<?php echo esc_url($this->plugin_menu_url); ?>"><?php echo sanitize_text_field($this->name); ?></a> plugin for over <?php echo sanitize_text_field($this->days); ?> days<?php echo (($this->debug === true)?' ('.$this->minutes.' minutes)':''); ?> now – entirely <b>for FREE :)</b></p>
