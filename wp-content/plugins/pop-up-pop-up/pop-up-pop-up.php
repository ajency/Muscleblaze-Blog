...
define('MPU_PLUGIN_VERSION_CURRENT', '1.1.9');
...
$blackfriday_banner = new \Inisev\Subs\InisevBlackFriday('pop-up-pop-up', 'MyPopUps', 'http://bit.ly/3ACbsdc', ['admin.php?page=wp-mypopups']);
